...
async function runYtdlp(args, timeout = 180000, {
    ...
    if (youtube) {
        ...
        // No usar cookies en audio; el cliente android evita el bloqueo de bot en VPS.
        if (useCookies) {
...
const YT_AUDIO_STRATEGIES = [
    { label: 'web', playerClient: null },
    // Cliente android: evita "Sign in to confirm you're not a bot" en IPs de datacenter (AWS/VPS)
